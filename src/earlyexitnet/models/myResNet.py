...
class ResNet_backbone(nn.Module):
    def __init__(self, block=BasicBlock, num_block=[], num_classes=10, init_weights=True):
...
class ResNet_2EE(ResNet_backbone):
    ...
    def __init__(self, block=BasicBlock, num_block=[], num_classes=10, data_shape=[1,3,32,32],
                 init_weights=True):
        '''
    ...
    def _build_exits(self): #adding early exits/branches
        ...
        ee1 = IntrClassif(self.in_chan_sizes[0], #TODO: branch before conv2 ->conv_x//why before conv2 not after? beacasue author did it wtf..
