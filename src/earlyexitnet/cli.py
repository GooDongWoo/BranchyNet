...
"""
import sys
sys.path.append('C:/Users/dongwoo/vs_proj/earlyexitnet/src')
import random
import os
import argparse
...
def main():
    ...
    # parse the arguments
    if len(sys.argv)==1:
        args = parser.parse_args("-m resnet8_2ee -bstr 64 -bbe 5 -jte 5 -d cifar10 -gpu 0 -bste 1 -t1 0.9 -entr 0.0001 -rn bravo".split())
    else:
